    ...
    <table class="table table-condensed">
        <thead>
            <tr>
                ...
                <th width="50"></th>
                <th class="text-right" width="110">Precio Compra</th>
                <th class="text-right" width="110">Precio Venta</th>
                <th class="text-right" width="110">Precio Combo</th>
                ...
                <th class="text-right" width="110">% Utilidad</th>
