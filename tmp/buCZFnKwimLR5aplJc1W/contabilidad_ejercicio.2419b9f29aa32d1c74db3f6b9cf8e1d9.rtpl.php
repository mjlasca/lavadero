...
<form action="<?php echo $fsc->url();?>" method="post" class="form">
   ...
   <div class="table-responsive">
      <table class="table table-hover">
         ...
         <tr>
            <td><input class="form-control" type="text" name="nombre" value="<?php echo $fsc->ejercicio->nombre;?>" autocomplete="off"/></td>
            <td><input class="form-control datepicker" type="text" name="fechainicio" value="<?php echo $fsc->ejercicio->fechainicio;?>"/></td>
            <td><input class="form-control datepicker" type="text" name="fechafin" value="<?php echo $fsc->ejercicio->fechafin;?>"/></td>
            <td><input class="form-control" type="number" name="longsubcuenta" value="<?php echo $fsc->ejercicio->longsubcuenta;?>"/></td>
            <td>
         ...
         <div class="modal-content">
            <div class="modal-header">
               ...
               <p class="help-block">
                  ...
                  <a href="https://www.facturascripts.com/foro/como-adaptar-facturascripts-a-tu-pais-este-pretende-250.html" target="_blank">Créalo</a>.
               </p>
            </div>
               ...
               <div class="row">
                  <div class="col-sm-6">
                     ...
                     <?php $loop_var1=$fsc->extensions; $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>
                        ...
                        <?php if( $value1->type=='fuente' ){ ?>

                        <div class="radio">
                           <label>
                              <input type="radio" name="fuente" value="<?php echo $value1->params;?>" checked=""/>
