...
<script type="text/javascript">
   ...
   $(document).ready(function () {
      ...
      var boton_pagar = "<?php echo $fsc->bandera_pagar;?>";
      ...
      <div class="row">
         <div class="col-xs-8">
            ...
            <div class="btn-group">
               ...
               <div class="btn-group">
               <input type="hidden" value="<?php echo $fsc->agente->codagente;?>" id="usuarioSistema" name="usuarioSistema">
               ...
               <a id="asientoAuto" class="btn btn-sm btn-default" href="<?php echo $fsc->url();?>&gen_asiento=TRUE&petid=<?php echo $fsc->random_string();?>">
            ...
            <div class="btn-group">
               <?php if( $fsc->factura->pagada ){ ?>
                     ...
                     <a class="btn btn-sm btn-primary"  href="<?php echo $fsc->url();?>&pagada=FALSE" >
                        <span class="glyphicon glyphicon-remove"></span> &nbsp; No pagar
                     </a>   
               <?php }else{ ?>

                     <a class="btn btn-sm btn-warning"  href="<?php echo $fsc->url();?>&pagada=TRUE" >
                        <span class="glyphicon glyphicon-ok"></span> &nbsp; Pagar
                     </a>        
               <?php } ?>

               
               <!-- value="<?php echo $fsc->url();?>&pagada=TRUE" 
         ...
         <div class="col-sm-12">
            ...
            <ol class="breadcrumb" style="margin-bottom: 5px;">
               ...
               <?php if( $fsc->cliente ){ ?>
                  ...
                  <li>
                     <a href="#" onclick="bootbox.alert({message: 'Cliente conocido como: <?php echo $fsc->cliente->nombre;?>',title: '<b>Atención</b>'});">
            ...
            <p>
               ...
               <?php  echo FS_FACTURA;?> creada por <a href="<?php echo $fsc->agente->url();?>"><?php echo $fsc->agente->get_fullname();?></a>.
               <?php }else{ ?>
      ...
      <div class="row">
         <div class="col-sm-2">
            <div class="form-group">
               ...
               <input class="form-control" type="text" name="numero2" disabled=""  value="<?php echo $fsc->factura->numero2;?>"/>
            </div>
         </div>
         <div class="col-sm-2">
            <div class="form-group">
         ...
         <div class="col-sm-2">
            <div class="form-group">
               Fecha:
               <input class="form-control datepicker" type="text" disabled="" name="fecha" value="<?php echo $fsc->factura->fecha;?>" autocomplete="off"/>
            </div>
         </div>
         <div class="col-sm-2">
            <div class="form-group">
               Hora:
               <input class="form-control" type="text" name="hora" disabled="" value="<?php echo $fsc->factura->hora;?>" autocomplete="off"/>
            </div>
         </div>
         <div class="col-sm-2">
            <div class="form-group">
         ...
         <div class="col-sm-2">
            <div class='form-group<?php if( $fsc->factura->vencida() ){ ?> has-warning<?php } ?>'>
               ...
               <input type="text" name="vencimiento" disabled="" value="<?php echo $fsc->factura->vencimiento;?>" class="form-control datepicker" readonly=""/>
               <?php }else{ ?>

               <input type="text" name="vencimiento" disabled="" value="<?php echo $fsc->factura->vencimiento;?>" class="form-control datepicker" autocomplete="off"/>
               <?php } ?>
            ...
            <div class="container-fluid" style="margin-top: 10px;">
               <div class="row">
                  ...
                  <div class="col-sm-2">
                     <div class="form-group">
                        <?php  echo FS_CIFNIF;?>:
                        <input class="form-control" type="text" name="cifnif" value="<?php echo $fsc->factura->cifnif;?>" maxlength="30" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-2">
                     <div class="form-group">
               ...
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        Código Postal:
                        <input class="form-control" type="text" name="codpostal" value="<?php echo $fsc->factura->codpostal;?>" maxlength="10" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="form-group">
            ...
            <div class="container-fluid" style="margin-top: 10px;">
               <div class="row">
                  <div class="col-sm-3">
                     <div class="form-group">
                        Nombre:
                        <input type="text" name="envio_nombre" value="<?php echo $fsc->factura->envio_nombre;?>" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-3">
                     <div class="form-group">
                        Apellidos:
                        <input type="text" name="envio_apellidos" value="<?php echo $fsc->factura->envio_apellidos;?>" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-2">
                     <div class="form-group">
                  ...
                  <div class="col-sm-4">
                     <div class="form-group">
                        ...
                        <input type="text" name="envio_codigo" value="<?php echo $fsc->factura->envio_codigo;?>" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
               </div>
               <div class="row">
                  ...
                  <div class="col-sm-3">
                     <div class="form-group">
                        <span class="text-capitalize"><?php  echo FS_PROVINCIA;?></span>:
                        <input type="text" name="envio_provincia" value="<?php echo $fsc->factura->envio_provincia;?>" id="ac_provincia2" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-3">
                     <div class="form-group">
                        Ciudad:
                        <input type="text" name="envio_ciudad" value="<?php echo $fsc->factura->envio_ciudad;?>" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-3">
                     <div class="form-group">
                        Código Postal:
                        <input type="text" name="envio_codpostal" value="<?php echo $fsc->factura->envio_codpostal;?>" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-6">
                     <div class="form-group">
                        Dirección:
                        <input type="text" name="envio_direccion" value="<?php echo $fsc->factura->envio_direccion;?>" class="form-control" autocomplete="off"/>
                     </div>
                  </div>
                  <div class="col-sm-3">
                     <div class="form-group">
