                     ...
                     <div class="panel-body">
                        <div class="row">
                           ...
                           <div class="col-sm-2">
                              <div class="form-group">
                                 <?php  echo FS_CIFNIF;?>:
                                 <input class="form-control" type="text" name="cifnif" value="<?php echo $fsc->proveedor->cifnif;?>" maxlength="30" autocomplete="off"/>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                              <div class="form-group">
                                 <label class="checkbox-inline">
                                    <?php if( $fsc->proveedor->jefe_patio ){ ?>

                                    <input type="checkbox" name="jefe_patio" value="FALSE" checked=""/>
                                    <?php }else{ ?>

                                    <input type="checkbox" name="jefe_patio" value="FALSE"/>
                                    <?php } ?>
                  ...
                  <div class='panel <?php if( $value1->direccionppal ){ ?>panel-primary<?php }else{ ?>panel-default<?php } ?>'>
                     ...
                     <div class="panel-body">
                        ...
                        <div class="col-sm-3">
                           <div class="form-group">
                              Código Postal:
                              <input class="form-control" type="text" name="codpostal" value="<?php echo $value1->codpostal;?>" maxlength="10" autocomplete="off"/>
                           </div>
                        </div>
                        <div class="col-sm-6">
                           <div class="form-group">
