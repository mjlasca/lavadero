            ...
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <?php if( $fsc->user->admin ){ ?>
                    ...
                    <input  type="text" name="fpagada" value="<?php echo $fsc->today();?>" required=""  class="form-control datepicker"  readonly="readonly" autocomplete="off"/>
                  <?php }else{ ?>

                    <input  type="text" name="fpagada" value="<?php echo $fsc->today();?>" required=""  readonly="readonly" autocomplete="off"/>
                  <?php } ?>
               ...
               <input type="hidden" value="<?php echo $fsc->url();?>&pagada=TRUE" name="enlaceAsiento" id="enlaceAsiento">
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            ...
            <div class="modal-body bg-warning">
               ...
               junto con la <?php  echo FS_FACTURA;?>. Además, se generará un hueco en la numeración y será reemplazado con la siguiente factura que se haga
               <?php }else{ ?>
