                  ...
                  <div class="row">
                     ...
                     <div class="col-sm-3">
                        <div class="input-group">
                           ...
                           <select name="familia_cons" class="form-control"  onchange="this.form.submit()">
                                 <option value="">---</option>
                              <?php $loop_var1=$fsc->familia->all(); $counter1=-1; if($loop_var1) foreach( $loop_var1 as $key1 => $value1 ){ $counter1++; ?>

                                 <?php if( $fsc->familia_cons == $value1->codfamilia ){ ?>

                                    <option value="<?php echo $value1->codfamilia;?>" selected=""><?php echo $value1->descripcion;?></option>
                                 <?php }else{ ?>
                     ...
                     <div class="col-sm-2">
                           <div class="input-group">
                              ...
                              <select name="servicio_cons" class="form-control" onchange="this.form.submit()" >
                                    
                                    <?php if( $fsc->servicio_cons != ''  ){ ?>


                                       <option value="">---</option>
                                       <?php if( $fsc->servicio_cons == 1 ){ ?>

                                          <option value="1" selected="">Servicio</option>
                                          <option value="0" >Artículo</option>
                                       <?php } ?>

                                       <?php if( $fsc->servicio_cons == 0 ){ ?>

                                          <option value="1" >Servicio</option>
                                          <option value="0" selected="">Artículo</option>
                                       <?php } ?>
            ...
            <div class="table-responsive">
               <table class="table table-hover">
                  ...
                  <tr class='clickableRow<?php if( $value1['articulo']->bloqueado ){ ?> danger<?php } ?>' href="<?php echo $value1['articulo']->url();?>">
                     ...
                     <td class="text-center"><?php echo $value1['familia'];?></td>
                     <td class="text-center"><?php echo $value1['servicio'];?></td>
