      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="fs-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
               ...
               <li class="dropdown">
                    <a href="<?php echo $fsc->url();?>&logout=TRUE&user_lav=<?php echo $fsc->user->nick;?>" onclick="return " id="sesion_cerrada" >
                  ...
                  <ul class="dropdown-menu">
                     <li>
                        <a href="<?php echo $fsc->user->url();?>">
                           <i class="fa fa-user-circle fa-fw" aria-hidden="true"></i> <?php echo $fsc->user->nick;?>
