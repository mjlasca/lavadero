...
<div id="tab_articulo" role="tabpanel">
   ...
   <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="home">
          <form action="<?php echo $fsc->url();?>" method="post" class="post" onsubmit="return verificarVarios()">
               ...
               <div class="row" style="padding-top: 10px;">
                  <div class="col-sm-3">
                      <div class="form-group">
                        ID:
                        <input class="form-control" type="text"  value="<?php echo $fsc->articulo->id_articulo;?>" readonly=""  autocomplete="off"/>
                     </div>      
                     <div class="form-group">
                        Referencia:
               ...
               <div class="row">
                  ...
                  <div class="col-sm-2">
                     <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="por_liquidacion" id="por_liquidacion" value="<?php echo $fsc->articulo->por_liquidacion;?>" autocomplete="off"/>
                     </div>
                     <div class="form-group">
                            % Producto instalado
                            <input class="form-control" type="textbox" name="necesita_articulo" value="<?php echo $fsc->articulo->necesita_articulo;?>" id="necesita_articulo"/>
               ...
               <div class="row">
                  ...
                  <div class="col-sm-2">
                     ...
                     <div class="checkbox">
                      ...
                      <div class="checkbox">
                        <label>
                           <input type="checkbox" name="servicio" value="TRUE"<?php if( $fsc->articulo->servicio ){ ?> checked=""<?php } ?>/>
                           Es Servicio
                        </label>
                     </div>
                  </div>
