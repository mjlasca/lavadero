...
trait linea_documento_venta
{
    ...
    /**
     * proveedores de servicio si aplican
     * @var array
     */
    public  $proveedor_lav;
    
    
    /**
     * Liquidación del artículo 
     * @var double
     */
    public  $val_liquidacion;
    
    /**
     * Liquidación del artículo 
     * @var double
     */
    public  $val_liquidacion_instalados;
    
    /**
     * Liquidación del artículo 
     * @var double
     */
    public  $val_liquidacion_jefes;
    ...
    private function load_data_trait($data)
    {
        ...
        $this->proveedor_lav = $data['proveedor_lav'];
        $this->val_liquidacion = $data['val_liquidacion'];
        $this->val_liquidacion_instalados = $data['val_liquidacion_instalados'];
        $this->val_liquidacion_jefes = $data['val_liquidacion_jefes'];
    }
    ...
    private function clear_trait()
    {
        ...
        $this->recargo = 0.0;
        $this->proveedor_lav = NULL;
        $this->val_liquidacion = 0;
        $this->val_liquidacion_instalados = 0;
        $this->val_liquidacion_jefes = 0;
