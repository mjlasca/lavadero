    ...
    private function nueva_factura_cliente()
    {
        ...
        if ($continuar) {
            ...
            if ($regularizacion->get_fecha_inside($factura->fecha)) {
                ...
                $consecutive->idcompany = $factura->idempresa;
                $consecutive->consecutive = $consecutive->get_by_idcompany_last($factura->idempresa) + 1;
                $consecutive->save();
                ...
                if ($continuar) {
                    ...
                    if (abs(floatval($_POST['tpv_total2']) - $factura->total) >= .02) {
                        ...
                        $this->downloadFact = $factura->idfactura;
