...
class registros_gasto extends fbase_controller
{
    ...
    {
        parent::__construct(__CLASS__, 'Registro Gasto', 'gastos', FALSE, FALSE);
    }
    ...
    protected function private_core()
    {
        ...
        $this->ppage = $this->page->get('registros_gastos');
        $this->agente = FALSE;
    ...
    private function get_factura_rectificativa()
    {
        ...
        if ($data) {
            $this->rectificativa = new registro_gasto($data[0]);
        }
    }
