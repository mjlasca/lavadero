...
class informe_consolidado extends fbase_controller
{
    ...
    public function getResultados(){
        ...
        $sqlGastos = "SELECT  IF(idmetodopago is NULL,'0',idmetodopago) as idmetodopago, SUM(total) as total FROM registro_gastos WHERE pagada=1 AND anulada = 0 AND total > 0 ";
        $sqlFactcli = "SELECT  IF(idmetodopago is NULL,'0',idmetodopago) as idmetodopago, SUM(total) as total FROM facturascli WHERE pagada=1 AND anulada = 0 AND total > 0 ";
