...
class proveedor extends \fs_model
{
    ...
    /**
     * TRUE -> jefe patio se diferencia del resto de los proeveedores de servicio, para escogerlos en el inicio de sesión
     * @var boolean
     */
    public $jefe_patio;
    ...
    public function __construct($data = FALSE)
    {
        ...
        if ($data) {
            ...
            $this->jefe_patio = $this->str2bool($data['jefe_patio']);
        ...
        if ($this->test()) {
            ...
            if ($this->exists()) {
                $sql = "UPDATE " . $this->table_name . " SET nombre = " . $this->var2str($this->nombre) .
                    ...
                    ", jefe_patio = " . $this->var2str($this->jefe_patio) .
               ...
               regimeniva,acreedor,personafisica,debaja,fechabaja,codcliente,jefe_patio) VALUES 
                    ...
                    "," . $this->var2str($this->jefe_patio) . ");";
                
                $cliente = new cliente();
                $cliente->nombre =   str_replace("'", "", $this->var2str($this->nombre));
                $cliente->razonsocial = str_replace("'", "", $this->var2str($this->nombre));
