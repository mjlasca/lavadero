...
class linea_factura_cliente extends \fs_model
{
        ...
        if ($this->test()) {
            if ($this->exists()) {
                $sql = "UPDATE " . $this->table_name . " SET "
                    ...
                    . ", proveedor_lav = " . $this->var2str($this->proveedor_lav)
                    . ", val_liquidacion = " . $this->var2str($this->val_liquidacion)
                    . ", val_liquidacion_instalados = " . $this->var2str($this->val_liquidacion_instalados)
                    . ", val_liquidacion_jefes = " . $this->var2str($this->val_liquidacion_jefes)
            ...
            $sql = "INSERT INTO " . $this->table_name . " (idfactura,idalbaran,idlineaalbaran,referencia,
               ...
               pvptotal,codimpuesto,iva,recargo,irpf,orden,mostrar_cantidad,mostrar_precio,proveedor_lav,val_liquidacion,val_liquidacion_instalados,val_liquidacion_jefes) VALUES 
                ...
                . "," . $this->var2str($this->proveedor_lav)
                . "," . $this->var2str($this->val_liquidacion)
                . "," . $this->var2str($this->val_liquidacion_instalados)
                . "," . $this->var2str($this->val_liquidacion_jefes) . ");";
    ...
    public function delete_lineas($id)
    {
        return $this->db->exec("DELETE FROM " . $this->table_name . " WHERE idfactura = " . $this->var2str($id) . ";");
    }
