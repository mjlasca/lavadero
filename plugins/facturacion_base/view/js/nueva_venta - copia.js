...
function get_imagen(dato){
        ...
        var result = "<img src='"+ 'images/articulos/' + dato + '-1.jpg'+"' WIDTH='100' HEIGHT='100'>";
       return result;
}
            ...
            $.getJSON(nueva_venta_url, $("form[name=f_buscar_articulos]").serialize(), function (json) {
                ...
                $.each(json, function (key, val) {
                    ...
                    if (val.sevende) {
                     ...
                     <td class=\"text-right\">" + stock + "</td><td class=\"text-right\"> <a href=\"#\" onclick=\"return " + funcion + "\">"+ get_imagen(val.referencia) +"</a> </td></tr>");
                    }
                ...
                if (insertar) {
                  ...
                  <th class=\"text-right\" width=\"100\">Img</th>\n\
